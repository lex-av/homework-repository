...
from homework9.pack_task1.module_task1 import merge_sorted_files, merge_two_sorted_files
...
def test_positive_merge_two_files():
    path_to_test = os.getcwd()
    file_paths = [
        path_to_test + "/homework9/tests/tests_data/task1_file1.txt",
        path_to_test + "/homework9/tests/tests_data/task1_file2.txt",
    ]
    assert list(merge_two_sorted_files(*file_paths)) == [1, 2, 3, 4, 5, 6]
